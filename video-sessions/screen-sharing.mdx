...
## When your client shares

Your client can share their screen with you as well. They'll see the same
**Share Screen** button in their toolbar, and what they share fills your
main stage the same way yours fills theirs — a form they're stuck on, a
letter they've received, something they want to show you rather than
describe.

Four things worth knowing before you ask them to:

- **It works on a computer, not a phone.** iPhones and iPads can't share
  a screen from a browser, so the button doesn't appear there. If your
  client is on a phone, ask them to describe what they're looking at.
- **Only they can stop it.** You can't end their share from your side. If
  they forget they're still sharing, ask them — they'll see a "Stop
  sharing" button in their own toolbar, and their browser puts up its own
  sharing bar as well.
- **One of you at a time.** If one of you is already sharing, the other
  sees a short note saying so. Whoever is sharing stops first.
- **The whiteboard stays with you.** Clients can share a screen; they
  can't open the whiteboard. That's still yours.

Starting an EMDR set counts as sharing too, because the stimulus reaches
your client the same way a shared screen does. If your client is sharing
when you go to start a set, Rivet will tell you, and they'll need to stop
first.
...
The same three work for your client, on their side.
...
- **The same applies to your client.** If you're asking them to share, it
  costs nothing to say "pick just the one window" first — they may not
  have thought about what else is open.
...
- **Screen sharing from a phone or tablet.** Neither you nor your client
  can share a screen from an iPhone or iPad. Everything else in a session
  works there.
