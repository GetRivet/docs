...
Rivet's price is **before sales tax**. The applicable Canadian sales
tax — HST, GST, or GST + PST depending on your province — is added on
top of your monthly total at checkout and calculated automatically;
you don't configure anything, and we don't either.

## What you pay, by province

The total you see at checkout, and on every monthly invoice, is your
monthly amount plus the relevant tax rate for your billing address. The
last column works it out for the **$65** plan — video, the clinical
toolkit and the practice line. On $45 or $20, the same rate applies to
that amount instead. As of writing:

| Your province | Tax | Rate | Monthly total on $65 |
|---|---|---|---|
