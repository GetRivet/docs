...
- **Cheques. Wire transfers. Crypto.** Not for a monthly subscription
  this size.
...
<Steps>
  ...
  <Step title="Tap Subscribe">
    ...
    the recurring billing. The first real charge — your monthly total
    plus sales tax — runs the same day.
  </Step>
