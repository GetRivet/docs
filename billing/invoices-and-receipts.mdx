...
- **Description** — what you have on, itemised: video and the clinical
  toolkit, and the practice line where you have one.
- **Amount** — your monthly total before tax: $65 with both parts on,
  $45 or $20 with one of them.
- **Sales tax** — the HST / GST / PST line, calculated based on your
  province. See [Canadian taxes](/billing/canadian-taxes).
- **Total** — your amount plus sales tax.
