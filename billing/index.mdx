...
Rivet's billing model is the simplest one we could justify: two
switches, month-to-month, paid by credit card. **$45 CAD a month, plus
$20 for the practice line** — both on by default, so most practices pay
**$65**. Pay yearly and it's 10% below twelve monthly payments. Cancel
anytime.
...
<CardGroup cols={2}>
  ...
  <Card title="Subscription pricing" icon="dollar-sign" href="/billing/subscription-pricing">
    $45 a month, plus $20 for the line. What each part covers.
  </Card>
...
- **You choose what's on, and the price follows.** $45 CAD per
  practitioner per month, plus $20 for the practice line. Whichever
  parts you have on, the price is the same whether you use one feature
  in them or all of them.
