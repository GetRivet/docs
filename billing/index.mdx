...
month-to-month, paid by credit card. **$65 CAD per practitioner per
month**, everything included. Pay yearly and it's 10% below twelve
...
- **One product, one price.** $65 CAD per practitioner per month. The
  same price whether you use one feature or every feature.
